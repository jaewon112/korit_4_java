...
/*
    ...
    일반 for문과의 차이점:
        ...
        배열명.length와 같은 방식으로 int값을 추출해서 한계값에 대입했습니다.

        그런데 잘 생각해보면 for(int i =0 ; ...)으로 작성할 때 int i는 for 문의 내부에서 선언됩니다
        (일종의 지역변수)
        ...
        제약 :
            읽기만 되고 쓰기가 안됩니다(예를 들어 1부터 100까지 추출하는건 되는데 , 1부터 100까지 입력은 불가능할 때가 잇습니다)

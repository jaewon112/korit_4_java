...
/*
    ...
    2. 기본 생성자를 이용하여 main에서 human1 객체를 생성하시오 -> 재정의가 요구됨
    ...
    5. getter를 재정의하여 getAnimalAge(); 를 호출했을때
    ...
    7. Human 클래스의 고유 메서드인 read() 메서드를 call2() 유형으로 정의하시오.
        ...
        여러분 이름은 자바의 기초를 일는 중입니다. 라고 출력될 수 있도록 코드를 작성하시오

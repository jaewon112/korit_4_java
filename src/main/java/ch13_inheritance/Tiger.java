...
// 부모의 필드를 그대로 사용할 수 있지만 , 자식 클래스만의 고유한 필드를 가질 수 있음
    private boolean striped;
    // 이상의 field는 부모에게 없기 때문에 setter /getter도 없음
    // 그렇다면 고유 필드의 경우에는 메서드를 정의해줄 필요가 있음.
    ...
    @Override
    public void move() {
        super.move();       //md파일에서 작성한 super키워드
        // super는 부모클래스의 객체를 의미함
        // 이상의 코드는 부모클래스인 Animal 클래스의 move() 메서드를 호출한다는 의미로 볼 수 있음.
        System.out.println("호랑이가 네 발로 걷습니다.");
        // 재정의를 위해 실행문을 추가 ( 재정의 할 것만 상속받는다.)
